...
* Docker instalation
    ...
    - Type this command sudo usermod -aG docker $USER by adding current user to the docker group we prevent typing sudo every time during execution docker commands.
